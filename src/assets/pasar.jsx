    ...
    return (
      <div className={styles.container}>
        ...
        <a
            ...
            href="/products/add" // Ganti dengan URL yang diinginkan
            target="_blank" // Opsional: membuka di tab baru
            rel="noopener noreferrer" // Opsional: untuk keamanan saat membuka tab baru
          >
            Create New Product
          </a>
        <div>
